...
import com.a1qs.the_vault_extras.world.structures.RuinedVaultPortalStructure;
...
public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, VaultExtras.MOD_ID);

    public static final RegistryObject<Structure<NoFeatureConfig>> RUINED_VAULT_PORTAL =
            STRUCTURES.register("ruined_vault_portal", RuinedVaultPortalStructure::new);
